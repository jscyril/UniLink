          ...
          <div className="self-stretch rounded-lg h-[478.5px] flex flex-col items-center justify-between sm:items-center sm:justify-center">
            <div className="flex flex-col items-start justify-start gap-[9px]">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  console.log("Title updated:", e.target.value); // Debugging line
                }}
            ...
            <div className="flex flex-col items-start justify-start gap-[12px]">
              ...
              <input
                ...
                className="[outline:none] bg-gray-700 w-[600px] relative rounded-lg box-border h-[130px] border-[1px] border-solid border-mediumslateblue"
                type="text"
              />
            </div>
