...
export default function Home() {
  ...
  return (
    <div className="w-full relative bg-gray-400 overflow-hidden py-20 flex flex-row items-start justify-start lg:w-auto lg:[align-self:unset] lg:gap-[0px] md:w-auto md:[align-self:unset] sm:w-auto sm:[align-self:unset]">
